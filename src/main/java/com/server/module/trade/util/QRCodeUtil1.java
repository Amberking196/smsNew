...
//                
//            // 插入图片    
//            QRCodeUtil1.insertImage(image, logoImage, needCompress);  
//              
//            if(needDescription)  
//                 return image;  
//              
//            QRCodeUtil1.addFontImage(image, bottomDes);  
//              
//            return image;    
//        }    
//        
...
//                
//            Image src =textImage;    
//            graph.drawImage(src, 0, QRCODE_SIZE - 40, width, height, null);     
//            graph.dispose();    
//        }  
//  
//        /**  
...
//                boolean needCompress) throws Exception {    
//                
//            BufferedImage image = QRCodeUtil1.createImage(content, CheckImageExist(imgPath),    
...
//                boolean needCompress) throws Exception {    
//                
//            BufferedImage image = QRCodeUtil1.createImage(content, logoImage, bottomDes,   
//                    needCompress);    
//            mkdirs(destPath);    
//            String file = UUID.randomUUID().toString()+".jpg";    
//            ImageIO.write(image, FORMAT_NAME, new File(destPath+"/"+file));    
...
//            QRCodeUtil1.encode(content, null,null,destPath, false);    
//        }    
//    
//        /** 
//         *    
...
//            BufferedImage image = QRCodeUtil1.createImage(content, CheckImageExist(imgPath), bottomDes,   
//                    needCompress);    
...
//                OutputStream output, boolean needCompress) throws Exception {    
//            BufferedImage image = QRCodeUtil1.createImage(content, Image, bottomDes,    
//                    needCompress);    
//            ImageIO.write(image, FORMAT_NAME, output);    
//        }    
//            
...
//                throws Exception {    
//            QRCodeUtil1.encode(content, null,null, output, false);    
//        }    
//    
//        /**  
//         * 解析 二维码  
...
////            QRCodeUtil1.encodeOfPath(text, "d:/test/a1.jpg",null,"d:/test", true);    
////            QRCodeUtil1.encode(text,"d:/test"); // 不带logo   
//            BufferedImage bi = ImageIO.read(new File("d:/log.png"));  
//               QRCodeUtil1.encode(text,bi,"1988000083","198800008","d:/test", true);  
//        }    
//            
//  
//          
