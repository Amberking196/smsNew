...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public boolean verify(Map<String, String> params , AlipayConfig alipayConfig) {
     ...
     * @return 生成的签名结果
     */
	private boolean getSignVeryfy(Map<String, String> Params, String sign , AlipayConfig alipayConfig) {
    ...
    */
    private String verifyResponse(String notify_id , AlipayConfig alipayConfig) {
