...
public class AlipayMsgBuildUtil {
     ...
     * @return
     */
    public String buildBaseAckMsg(String fromUserId,AlipayServiceEnvConfig alipayServiceEnvConfig) {
        StringBuilder sb = new StringBuilder();
        sb.append("<XML>");
        sb.append("<ToUserId><![CDATA[" + fromUserId + "]]></ToUserId>");
        sb.append("<AppId><![CDATA[" + alipayServiceEnvConfig.app_id + "]]></AppId>");
